...
public abstract class Movimiento {
	...
	/**
	 * Deshace el movimiento en el tablero recibido como par�metro. Se puede dar por cierto que el movimiento se ejecut� sobre ese tablero; en caso contrario, el comportamiento es indeterminado.
