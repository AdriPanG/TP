...
public class Tablero implements TableroInmutable {
	...
	/**
	 * Comprueba que la casilla que se va a introducir entra dentro del tamaño del tablero.
	 * @param x - Número de la columna.
	 * @param y - Número de la fila.
	 * @return true si se puede añadir al tablero, false si no se puede.
	 */
